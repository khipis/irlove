...
(function () {
  ...
  var LOCALES = {
    pl: {
      ...
      profile_choose: 'Wybierz',
      profile_mood: 'Nastrój',
      profile_bio: 'Opis',
      profile_bio_placeholder: 'Np. Lubię kawę i rozmowy…',
      error_age_invalid: 'Wiek: od 16 do 105 lat.',
      error_height_invalid: 'Wzrost: od 30 do 240 cm.',
      ...
      profile_tag_coffee: '☕ Kawka',
      profile_tag_walk: '🚶 Spacer',
      profile_tag_sport: '🏃 Sport',
      map_status_loading: 'Ładowanie…',
      map_status_online: 'Jesteś widoczny',
      map_status_placeholder: 'Statement… (znika za 20 s)',
      map_status_offline: 'Offline',
      map_nearby: 'W pobliżu',
      powerup_wave: 'Pomachaj',
      powerup_hearts: 'Fontanna serc',
      powerup_fire: 'Ogień',
      powerup_anger: 'Wściekłość',
      powerup_sad: 'Smutek',
      powerup_surprise: 'Wow',
      powerup_laugh: 'Śmiech',
      map_you: 'Ty',
    ...
    en: {
      ...
      error_age_invalid: 'Age must be between 16 and 105.',
      error_height_invalid: 'Height must be between 30 and 240 cm.',
      profile_interests: 'Interests',
      profile_tags: 'Availability',
      profile_tag_chat: '💬 Chat',
      profile_tag_date: '❤️ Date',
      profile_tag_beer: '🍺 Beer',
      profile_tag_coffee: '☕ Coffee',
      profile_tag_walk: '🚶 Walk',
      profile_tag_sport: '🏃 Sport',
      map_status_loading: 'Loading…',
      map_status_online: 'You are visible',
      map_status_placeholder: 'Statement… (gone in 20 s)',
      map_status_offline: 'Offline',
      map_nearby: 'Nearby',
      powerup_wave: 'Wave',
      powerup_hearts: 'Heart fountain',
      powerup_fire: 'Fire',
      powerup_anger: 'Rage',
      powerup_sad: 'Sad',
      powerup_surprise: 'Wow',
