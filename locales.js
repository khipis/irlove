...
(function () {
  ...
  var LOCALES = {
    pl: {
      ...
      ios_https_hint: 'Na iPhonie Safari udostępnia lokalizację tylko na stronach HTTPS. Otwórz aplikację przez adres https:// (np. wdrożoną stronę lub tunel jak ngrok).',
    ...
    en: {
      ...
      ios_https_hint: 'On iPhone, Safari only allows location on HTTPS pages. Open the app via https:// (e.g. a deployed site or a tunnel like ngrok).',
